...
public class CQLLibraryDeleteEvent extends GwtEvent<CQLLibraryDeleteEvent.Handler> {
	...
	public static com.google.gwt.event.shared.GwtEvent.Type<Handler> TYPE = 
			new GwtEvent.Type<CQLLibraryDeleteEvent.Handler>();
	 ...
	 *            the message
	 */
	public CQLLibraryDeleteEvent(boolean isDeleted, String message){
