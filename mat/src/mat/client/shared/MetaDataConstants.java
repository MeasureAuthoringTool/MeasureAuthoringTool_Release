...
public class MetaDataConstants {
	...
	/** The Constant CLINICAL_RECOM_STATE. */
	public static final String CLINICAL_RECOM_STATE ="ClinicalRecomms";
	
	/** The Constant IMPROVEMENT_NOTATION. */
