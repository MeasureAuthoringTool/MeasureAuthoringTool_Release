...
public class CQLVersionEvent extends GwtEvent<CQLVersionEvent.Handler> {
	...
	public static com.google.gwt.event.shared.GwtEvent.Type<Handler> TYPE = 
			new GwtEvent.Type<CQLVersionEvent.Handler>();
	 ...
	 *            the message
	 */
	public CQLVersionEvent(boolean isVersioned, String versionName, String message){
