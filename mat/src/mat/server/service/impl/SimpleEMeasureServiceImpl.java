...
public class SimpleEMeasureServiceImpl implements SimpleEMeasureService{
	...
	private static final String XPATH_ALL_MSR_OBS_ELEMENTREF_ID = "/measure/measureObservations/clause//elementRef/@id";
	private static final String XPATH_ALL_STARTA_ELEMENTREF_ID = "/measure/strata/clause//elementRef/@id";
	...
	private static final String XPATH_ALL_MSR_OBS_ATTRIBUTES_UUID = "/measure/measureObservations/clause//attribute/@qdmUUID";
	private static final String XPATH_ALL_STARTA_ATTRIBUTES_UUID = "/measure/strata/clause//attribute/@qdmUUID";
	...
	public ExportResult exportMeasureIntoSimpleXML(String measureId ,String xmlString) throws Exception {	
		...
		// for (int i = 0; i < allGroupedElementRefIDs.getLength(); i++) {
		// Node idNode = allGroupedElementRefIDs.item(i);
		...
		// for (int i = 0; i < allGroupedAttributesUUIDs.getLength(); i++) {
		// Node idNode = allGroupedAttributesUUIDs.item(i);
		// String idNodeValue = idNode.getNodeValue();
		// for (QualityDataSetDTO dataSetDTO : masterRefID) {
		// if (dataSetDTO.getUuid().equalsIgnoreCase(idNodeValue)) {
		// qdmRefID.add(dataSetDTO.getId());
	...
	private void findAndAddDTO(NodeList nodeList,
			List<QualityDataSetDTO> masterRefID, List<String> finalIdList) {
