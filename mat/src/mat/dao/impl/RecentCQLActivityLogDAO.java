...
public class RecentCQLActivityLogDAO extends GenericDAO<RecentCQLActivityLog, String> implements mat.dao.RecentCQLActivityLogDAO {

	/** The Constant logger. */
	private static final Log logger = LogFactory.getLog(RecentCQLActivityLogDAO.class);
	
	/**
	 * Records CQL in recent CQL activity log for the given CQL ID and user ID. 
	 * 
