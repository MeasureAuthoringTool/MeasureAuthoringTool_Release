...
public interface ListObjectDAO extends IDAO<ListObject, String> {
	public int countSearchResultsByUser(String searchText, String userId,boolean defaultCodeList);
	public List<CodeListSearchDTO> searchByUser(String searchText, String userId,
			int startIndex, int pageSize, String sortColumn, boolean isAsc,boolean defaultCodeList);
	
	public int countSearchResultsByMeasure(String searchText, Measure measure,boolean defaultCodeList);
	public List<CodeListSearchDTO> searchByMeasureOwner(String searchText,String ownerId,
			int startIndex, int pageSize, String sortColumn, boolean isAsc,boolean defaultCodeList);
	...
	public List<CodeListSearchDTO> searchWithFilter(String searchText, String loggedInUserid, int i, 
